            ...
            <div class="p-5">
                <div class="flex justify-between items-start mb-2">
                    <div>
                        ...
                        <span class="text-xs px-3 py-1 bg-emerald-100 text-emerald-700 rounded-full">${produto.categoria}</span>
                    </div>
                    <div class="text-right">
                        <div class="font-bold text-xl">R$ ${produto.preco}</div>
                    </div>
                </div>
                <button onclick="adicionarAoCarrinho(${produto.id})" class="mt-3 w-full bg-blue-600 hover:bg-blue-700 text-white py-3 rounded-2xl font-medium flex items-center justify-center gap-2">
        ...
        carrinho.forEach((item, index) => {
            ...
            const itemHTML = `
                <div class="flex gap-4 border-b pb-4">
                    ...
                    <button onclick="removerDoCarrinho(${index})" class="text-red-500 hover:text-red-700">x</button>
                </div>
            `;
